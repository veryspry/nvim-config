...
-- Typescript plugin that replaces typescript language server
...
--         -- zls = {},
--
--         -- TODO possible replace with https://github.com/pmizio/typescript-tools.nvim
--         -- ts_ls = {},
--
--         lua_ls = {
--           -- cmd = { ... },
...
--           },
--           capabilities = {},
--           -- root_dir = require('lspconfig').util.root_pattern('wp-config.php', '.git', 'composer.json', '.phpactor.json', '.phpactor.yml'),
